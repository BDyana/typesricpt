...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen backdrop-blur-md w-full z-50 absolute inset-0 flex items-center justify-center bg-background/80">
