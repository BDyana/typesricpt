    ...
    <div className="sm:col-span-3 sm:block bg-white border border-gray-300 rounded-sm hidden">
      ...
      <div className="py-2 h-[350px] flex flex-col gap-2 text-sm relative">
        <ul className="">
          ...
          <li className="group">
            ...
            <ul className="absolute left-[275px] top-0 z-10 w-full px-3 py-1 bg-white h-[340px] hidden group-hover:block">
              <div>
                ...
                <li className="">
                  <Link href="/categories/wool-thread" className="hover:text-black transition-all"
                  >Wool Thread</Link>
                </li>
                <li className="">
                ...
                <li className="">
                  <Link className="hover:text-black transition-all" href="/categories/lacchi-suta">Lacchi Thread</Link>
                </li>
              </div>
            </ul>
          </li>
          <li className="">
            <Link href="#" className="pl-3 py-1 flex items-center gap-3 hover:bg-slate-100 duration-300 transition-all"
            ><Laptop size={16} /><span className="text-sm">Computer & Hardware</span></Link>
          </li>
          <li className="group">
            <Link href="/categories/gadget-accessories" className="pl-3 py-1 flex items-center gap-3 hover:bg-slate-100 duration-300 transition-all"><Cpu size={16} /><span className="text-sm">Mobile & Gadget</span>
              <ChevronRight className="mr-1 shrink-0 w-4 h-4 right-0 absolute hidden group-hover:block" />
            </Link>
            <ul className="absolute left-[275px] top-0 z-10 w-full px-3 py-1 bg-white h-[340px] hidden group-hover:block">
              <div>
                ...
                <li className="">
                  <Link href="/categories/smartphone" className="hover:text-black transition-all">Infinix</Link>
                </li>
              </div>
            </ul>
          </li>
          ...
          <li className="group">
            <Link href="/categories/three-pieces" className="pl-3 py-1 flex items-center gap-3 hover:bg-slate-100 duration-300 transition-all">
              <BookHeart size={16} />
            ...
            <ul className="absolute left-[275px] top-0 z-10 w-full px-3 py-1 bg-white h-[340px] hidden group-hover:block space-y-3 text-gray-600">
              <div>
                ...
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/cleanser">Cleanser</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/facewash">Facewash</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/hair-oil">Hair Oil</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/toner">Toner</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/serum">Serum</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/moisturiser-cream">Moisturiser Cream</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/moisturising-lotion">Moisturising Lotion</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/repair-cream">Repair Cream</Link>
                </li>
              </div>
              <div>
          ...
          <li className="group">
            ...
            <ul className="absolute left-[275px] top-0 z-10 w-full px-3 py-1 bg-white h-[340px] hidden group-hover:block space-y-3">
              <div className="">
                ...
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/rice">Rice</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/sunflower-oil">Sunflower Oil</Link>
                </li>
              </div>
              <div className="">
                <h3 className="mb-1">Beverage</h3>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/coffee">Coffee</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/cerelac">Apple Cider Viengar</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/rice">Dry Fruits</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/cerelac">Organic Food</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/cerelac">Coconut Oil</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link className="hover:text-blue-700" href="/categories/cerelac">Coconut Milk</Link>
                </li>
                <li className="hover:text-blue-700">
                  <Link
                    className="hover:text-blue-700"
